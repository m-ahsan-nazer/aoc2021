...
def get_antinodes_for_coords_pairs(
    ...
    """
    In particular, an antinode occurs at any point that is perfectly in line with two
    ...
    antinodes = []
    for p in (p3, p4):
        if p.coords in input_data:
            antinodes.append(p.coords)
    return antinodes
